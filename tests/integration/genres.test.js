...
describe('/api/genres', () => {
    ...
    describe('GET /:id', () => {
        ...
        it('should throw 404 if invalid id', async () => {
        ...
        it('should throw 404 if no genre with the given id exists', async () => {
    ...
    describe('POST /', () => {
        ...
        it('should return return 400 if genre is less than 5 chars', async () => {
            name = '1234';
        ...
        it('should return return 400 if genre is more than 50 chars', async () => {
